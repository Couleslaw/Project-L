...
public class PlayerSelectionRowManager : MonoBehaviour
{
    ...
    private bool _trimmedInputFieldContent = false;
    ...
    /// </summary>
    private readonly List<LoadedPlayerTypeInfo> _availablePlayerInfos = new() { new LoadedPlayerTypeInfo(typeof(HumanPlayer), "Human", null) };
    ...
    /// </summary>
    public LoadedPlayerTypeInfo? PlayerType { get; private set; }
    ...
    public void OnInputFieldEndEdit(string value)
    {
        if (playerNameInput!.text != value.Trim()) {
            ...
            _trimmedInputFieldContent = true;
        }
        UpdateUI();
    }
