...
namespace ProjectL.FinalResultsScene
{
    ...
    /// <summary>
    /// Manages the <c>PlayerStatsColumn</c> prefab. Represents a column in the final results screen that contains information about how the player performed in the game and can animate it.
    /// </summary>
